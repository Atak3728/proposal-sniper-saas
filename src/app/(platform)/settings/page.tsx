      ...
      <main className="flex-1 flex flex-col h-full overflow-hidden relative transition-colors duration-300">
        ...
        <header className="h-16 border-b border-[rgba(0,0,0,0.08)] dark:border-border-dark flex items-center justify-between px-6 md:px-10 bg-white/80 dark:bg-background-dark/80 backdrop-blur-md z-10 sticky top-0 transition-colors">
          <div className="flex items-center gap-2 text-sm text-gray-500 dark:text-[#ab9cba]">
            ...
            <span className="text-gray-900 dark:text-white font-medium">General & Profile</span>
          </div>
        ...
        <div className="flex-1 overflow-y-auto p-6 md:p-10 scroll-smooth">
          <div className="max-w-4xl mx-auto space-y-6 pb-20">
            <div className="flex flex-col gap-2 mb-6">
              ...
              <p className="text-gray-500 dark:text-[#ab9cba] text-base font-light max-w-2xl">Manage your personal details and subscription preferences.</p>
            </div>
            <section className="bg-white dark:bg-glass-panel border border-gray-200 dark:border-glass-border rounded-xl p-5 md:p-6 shadow-sm dark:shadow-none transition-colors">
            ...
            <section className="bg-white dark:bg-glass-panel border border-gray-200 dark:border-glass-border rounded-xl p-6 md:p-8 relative overflow-hidden group shadow-sm dark:shadow-none transition-colors">
            ...
            <section className="bg-white dark:bg-glass-panel border border-gray-200 dark:border-glass-border rounded-xl p-5 md:p-6 flex items-center justify-between shadow-sm dark:shadow-none transition-colors">
              <div>
